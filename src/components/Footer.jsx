                ...
                <div className="grid mb-8 lg:grid-cols-6">
                    <div className="grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4">
                        ...
                        <div>
                            ...
                            <ul className="mt-2 space-y-2">
                                ...
                                <li>
                                    <a href={"/"} className="text-gray-500 transition-colors duration-300
                                    hover:text-orange-500">Forums</a>
                                </li>
                                <li>
                                    <a href={"/"} className="text-gray-500 transition-colors duration-300
                                    hover:text-orange-500">Projects</a>
                    ...
                    <div className="md:max-w-md lg:col-span-2 lg:mt-0 mt-5">
                        ...
                        <form className="mt-4 flex flex-col md:flex-row">
                            ...
                            mb-3 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none
                            ...
                            font-medium tracking-wide text-white transition duration-200 rounded shadow-md hover:bg-orange-500
                            focus:outline-none border">
                                Subscribe
                            </button>
                        </form>
                        <p className="mt-4 text-sm text-gray-500">Lorem ipsum dolor sit amet conesecto adispiscing elit.
                            sunt nisi Lorem ipsum dolor sit amet conesecto adispiscing elit. sunt nisi
                            Lorem ipsum dolor sit amet conesecto adispiscing elit. sunt nisi
                        </p>
                    </div>
                </div>

                <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
                    <p className="text-sm text-gray-500"> © Copyright 2023 | All rights reserved by JP</p>
